 ...
 * методами навикгации по дереву и получения доп. информации о его структуре.
 * <br> Этот функционал может быть невостребованым с точке зрения практического примения бинарного дерева поиска,
